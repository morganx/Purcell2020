...
alignment <- AlignSeqs(DNAStringSet(seqs), processors = NULL)
saveRDS(alignment, file = "DECIPHER_alignment.rds")
print("DECIPHER Complete")

# Save fasta alignment object
writeXStringSet(alignment, file = "purcell_fasta_alignment.fasta")
print("fasta Alignment Object Created")

# Convert to phylip format
phyAlignment <- phyDat(as(alignment, "matrix"), type = "DNA")

# Save phylip alignment object
write.phyDat(phyAlignment, file = "purcell_phylip_alignment.phy")
print("phylip Alignment Object Created")
