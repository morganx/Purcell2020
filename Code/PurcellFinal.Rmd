...
BC_plot <- ggplot(bcdf, aes(x = NMDS1, y = NMDS2)) +
  ...
  labs(title = "Bray-Curtis Ordination - Rarefied Data", color = "Sample Type") +
...
BC_plotNR <- ggplot(bcdfNR, aes(x = NMDS1, y = NMDS2)) +
  ...
  labs(title = "Bray-Curtis Ordination - Unrarefied Data", color = "Sample Type") +
  theme(aspect.ratio = 1, plot.margin = unit(c(0, 1, 0, 0), "pt"))
...
UWF_plot <- ggplot(wuni, aes(x = NMDS1, y = NMDS2)) +
  ...
  labs(title = "Weighted UniFrac Ordination", color = "Sample Type") +
